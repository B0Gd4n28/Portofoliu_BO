...
const translations = {
  ro: {
    ...
    // Blog Page
    navBlog: "Blog",
    blogTag: "// Blog & Resurse",
    blogTitle: 'Ghiduri Despre <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-500">Web, AI & Business</span>',
    blogSubtitle: "Articole practice cu sfaturi concrete pentru antreprenori care vor să-și digitalizeze business-ul în 2026.",
    blogStat1: "5 Articole",
    blogStat2: "~40 min citire totală",
    blogStat3: "Web · AI · SEO · Business",
    blogReadArticle: "Citește Articolul",
    blogTocTitle: "Cuprins",
    blogTocCta: "Consultanță Gratuită",
    blogShare: "Distribuie:",
    blogCtaBadge: "Ți-a plăcut ce ai citit?",
    blogCtaTitle: "Ai Întrebări Despre Proiectul Tău?",
    blogCtaDesc: "Consultanță gratuită, fără obligații. Discutăm ce soluție digitală este potrivită pentru business-ul tău.",
    blogCtaBtn1: "Scrie-mi pe WhatsApp",
    blogCtaBtn2: "Trimite un Mesaj",
    blogFooterServices: "Servicii populare",
    blogFooterS1: "Aplicații Web Full-Stack",
    blogFooterS2: "Soluții AI & Chatbot",
    blogFooterS3: "Aplicații Mobile",
    blogFooterS4: "E-commerce & Marketplace",
    blogFooterS5: "Marketing Digital",
    b1Tag: "Ghid Prețuri",
    b1Read: "8 min",
    b1CardTitle: "Cât Costă un Website în 2026?",
    b1CardExcerpt: "Ghid complet de prețuri: landing page, website business, e-commerce, aplicație cu AI. Află exact cât investești.",
    b1TocLink: "Cât Costă un Website?",
    b1Title: "Cât Costă un Website în 2026? Ghid Complet de Prețuri",
    b1Date: "25 Februarie 2026",
    b1ReadFull: "8 min citire",
    b1Intro: '<strong>Întrebarea #1 pe care o primesc de la clienți:</strong> „Cât costă un website?" Răspunsul depinde de mai mulți factori, dar în acest ghid îți explic exact ce poți aștepta în 2026.',
    b1H3_1: "💰 Tipuri de website și prețuri orientative în 2026",
    b1C1Title: "Landing Page / One-Page",
    b1C1Desc: "1-2 săptămâni · Design modern · SEO de bază · Mobile responsive · Formular contact",
    b1C2Title: "Website Business (5-10 pagini)",
    b1C2Desc: "3-6 săptămâni · CMS admin · Blog · SEO complet · Google Analytics · Multi-pagini",
    b1C3Title: "E-commerce / Magazin Online",
    b1C3Desc: "6-10 săptămâni · Catalog produse · Plăți online · Coș de cumpărături · Admin panel",
    b1C4Title: "Aplicație Web Custom cu AI",
    b1C4Desc: "2-4 luni · CRM/Marketplace · AI Chatbot · Auth & RBAC · API integrations · SaaS",
    b1H3_2: "📊 Ce influențează prețul unui website?",
    b1F1: '<strong>Complexitatea</strong> — câte pagini, funcționalități, integrări API, baze de date',
    b1F2: '<strong>Designul</strong> — template adaptat vs. design custom de la zero în Figma',
    b1F3: '<strong>Integrarea AI</strong> — chatbot OpenAI, automatizări, recomandări personalizate',
    b1F4: '<strong>SEO & Marketing</strong> — optimizare pentru motoare de căutare, Schema markup, analytics',
    b1F5: '<strong>Mentenanța</strong> — hosting, update-uri, backup-uri, suport post-lansare',
    b1H3_3: "🎯 De ce merită să investești într-un website profesional?",
    b1P1: 'Un website este <strong>cea mai importantă investiție digitală</strong> pentru orice business în 2026. 87% din consumatori caută online înainte de a cumpăra.',
    b1P2: 'Spre deosebire de reclamele plătite, un website bine optimizat <strong>atrage trafic organic gratuit</strong> luni și ani la rând.',
    ...
    b2CardExcerpt: "Cum inteligența artificială transformă business-urile: chatboți, automatizare, marketing personalizat.",
    b2TocLink: "De Ce AI în 2026?",
    b2Title: "De Ce Business-ul Tău Are Nevoie de AI în 2026",
    b2Date: "25 Februarie 2026",
    b2ReadFull: "7 min citire",
    b2Intro: 'În 2026, <strong>inteligența artificială nu mai este un lux</strong> — este o necesitate. Business-urile care nu folosesc AI pierd teren în fața competiției.',
    b2H3_1: "🤖 5 Moduri în care AI Îți Transformă Business-ul",
    b2Ai1Title: "Chatbot AI — Support 24/7",
    b2Ai1Desc: 'Un chatbot bazat pe ChatGPT/OpenAI răspunde clienților tăi instant, non-stop. Crește conversiile cu <strong>până la 40%</strong>.',
    b2Ai2Title: "Automatizare Marketing",
    b2Ai2Desc: "Email-uri personalizate automat, segmentare audiență cu AI, campanii WhatsApp inteligente.",
    b2Ai3Title: "Analiza Datelor cu AI",
    b2Ai3Desc: "AI analizează comportamentul clienților, identifică pattern-uri de cumpărare, prevede tendințe.",
    b2Ai4Title: "Generare Content cu AI",
    b2Ai4Desc: "Descrieri de produse, articole SEO, postări social media — totul generat și optimizat cu AI.",
    b2Ai5Title: "Boți Telegram & WhatsApp",
    b2Ai5Desc: "Boți custom care procesează comenzi, trimit notificări, gestionează programări.",
    b2H3_2: "📈 Statistici care contează",
    b2Stat1: "Conversii cu chatbot AI",
    b2Stat2: "Timp pe sarcini repetitive",
    b2Stat3: "Clienți caută online",
    b2Stat4: "Disponibilitate chatbot",
    b2CtaTitle: "Vrei să integrezi AI în business-ul tău?",
    b2CtaDesc: "Discut gratuit cum poți implementa chatboți, automatizări și soluții AI personalizate.",
    b2CtaBtn: "Vezi Serviciile AI",
    b3Tag: "Ghid Practic",
    b3Read: "10 min",
    b3CardTitle: "Cum Alegi un Web Developer?",
    b3CardExcerpt: "10 criterii esențiale pentru a alege developer-ul potrivit: portofoliu, tehnologii, preț, suport.",
    b3TocLink: "Cum Alegi un Developer?",
    b3Title: "Cum Să Alegi un Web Developer în 2026: 10 Criterii Esențiale",
    b3Date: "25 Februarie 2026",
    b3ReadFull: "10 min citire",
    b3Intro: 'Alegerea unui web developer poate fi copleșitoare. <strong>Există mii de opțiuni</strong> — freelanceri, agenții, platforme. Iată <strong>10 criterii concrete</strong>.',
    b3C1Title: "Portofoliu cu proiecte reale",
    b3C1Desc: "Un developer bun are un portofoliu cu proiecte live, nu doar mockup-uri.",
    b3C2Title: "Tehnologii moderne (2026-ready)",
    b3C2Desc: "Caută un developer care folosește React, Laravel, Node.js, TailwindCSS.",
    b3C3Title: "Cunoștințe de AI & automatizare",
    b3C3Desc: "Un developer care nu știe să integreze AI este în urma timpului.",
    b3C4Title: "SEO de la bun început",
    b3C4Desc: "Un website fără SEO este un website invizibil.",
    b3C5Title: "Design responsive (mobile-first)",
    b3C5Desc: "70% din trafic vine de pe mobil. Un developer bun construiește mai întâi pentru mobil.",
    b3C6Title: "Comunicare clară și rapidă",
    b3C6Desc: "Un developer care dispare zile la rând este un semnal de alarmă major.",
    b3C7Title: "Suport post-lansare inclus",
    b3C7Desc: "30 zile de suport gratuit minim.",
    b3C8Title: "Preț transparent, fără surprize",
    b3C8Desc: "Plata în etape (avans, milestone, livrare) este standardul de încredere.",
    b3C9Title: "Full-stack vs. specialist",
    b3C9Desc: "Un full-stack developer acoperă tot — un singur punct de contact.",
    b3C10Title: "Recenzii și testimoniale reale",
    b3C10Desc: "Un developer cu clienți mulțumiți este cel mai bun indicator de calitate.",
    b3CtaTitle: "Bifez toate cele 10 criterii ✓",
    b3CtaDesc: "Portofoliu cu proiecte live, tehnologii moderne, AI integration, SEO, suport 30 zile.",
    b3CtaBtn1: "Vezi Portofoliul",
    b3CtaBtn2: "Discută Proiectul Tău",

    // Blog Article 4: SEO în 2026
    b4Tag: "SEO & Vizibilitate",
    b4Read: "9 min",
    b4CardTitle: "SEO în 2026: Ghid Complet",
    b4CardExcerpt: "Cum să-ți optimizezi site-ul pentru Google: cuvinte cheie, viteza, conținut, backlink-uri și AI SEO.",
    b4TocLink: "SEO Ghid Complet 2026",
    b4Title: "SEO în 2026: Ghid Complet pentru Începători",
    b4Date: "28 Februarie 2026",
    b4ReadFull: "9 min citire",
    b4Intro: '<strong>SEO (Search Engine Optimization)</strong> este procesul prin care îți optimizezi website-ul pentru a apărea pe primele poziții în Google. În 2026, regulile s-au schimbat dramatic — AI, Core Web Vitals și conținutul de calitate sunt mai importante ca niciodată.',
    b4H3_1: "🔍 Ce este SEO și de ce contează în 2026?",
    b4P1: "93% din experiențele online încep cu un motor de căutare. Dacă website-ul tău nu apare pe prima pagină Google, <strong>practic nu exiști online</strong>. SEO este investiția cu cel mai mare ROI pe termen lung — fiecare articol optimizat atrage trafic gratuit luni și ani la rând.",
    b4H3_2: "📊 7 Piloni ai SEO Modern în 2026",
    b4C1Title: "Core Web Vitals (Viteza paginii)",
    b4C1Desc: "Google măsoară LCP, FCP, CLS și TBT. Un site care se încarcă în sub 2 secunde primește un boost semnificativ. Comprimă imaginile, minifică CSS/JS, folosește CDN.",
    b4C2Title: "Conținut de calitate (E-E-A-T)",
    b4C2Desc: "Google evaluează Experience, Expertise, Authoritativeness, Trustworthiness. Scrie conținut original, detaliat, care rezolvă probleme reale ale utilizatorilor.",
    b4C3Title: "Cuvinte cheie (Keyword Research)",
    b4C3Desc: 'Folosește Google Keyword Planner, Ubersuggest sau Ahrefs. Concentrează-te pe long-tail keywords cu intenție comercială: „cât costă website" nu doar „website".',
    b4C4Title: "Schema Markup (Date Structurate)",
    b4C4Desc: "Adaugă JSON-LD Schema.org: FAQ, HowTo, BreadcrumbList, LocalBusiness. Google afișează rich snippets care cresc CTR-ul cu 20-40%.",
    b4C5Title: "Mobile-First Indexing",
    b4C5Desc: "Google indexează versiunea mobilă mai întâi. 70%+ din trafic vine de pe mobil. Design responsive nu este opțional — este obligatoriu.",
    b4C6Title: "Backlink-uri de calitate",
    b4C6Desc: "Link-urile de pe alte site-uri către tine = voturi de încredere. Guest posting, directoare locale, parteneriate. Calitatea bate cantitatea.",
    b4C7Title: "AI SEO & AEO (Answer Engine Optimization)",
    b4C7Desc: "În 2026, AI-urile (ChatGPT, Gemini, Copilot) citesc Schema.org și conținutul structurat. Optimizează pentru motoarele AI, nu doar Google.",
    b4H3_3: "🎯 Checklist SEO Rapid (10 puncte)",
    b4F1: "<strong>Title tag</strong> unic pe fiecare pagină (50-60 caractere, cu keyword principal)",
    b4F2: "<strong>Meta description</strong> atractivă (150-160 caractere, cu CTA)",
    b4F3: "<strong>H1 unic</strong> pe fiecare pagină + H2, H3 ierarhice cu keywords",
    b4F4: "<strong>Imagini optimizate</strong> — format WebP, alt text descriptiv, lazy loading",
    b4F5: "<strong>HTTPS activ</strong> — certificat SSL obligatoriu (penalizare fără el)",
    b4F6: "<strong>Sitemap XML</strong> + robots.txt corect configurat",
    b4F7: "<strong>Google Search Console</strong> + Google Analytics 4 conectate",
    b4F8: "<strong>Internal linking</strong> — leagă paginile relevante între ele",
    b4F9: "<strong>Schema.org</strong> — JSON-LD pe fiecare pagină (FAQ, BreadcrumbList, etc.)",
    b4F10: "<strong>Conținut regulat</strong> — blog cu articole optimizate, minim 2/lună",
    ...
    b5CardExcerpt: "Cele mai frecvente erori: site lent, fără SEO, fără mobile, fără SSL, fără analytics. Cum le eviți.",
    b5TocLink: "5 Greșeli Frecvente",
    b5Title: "5 Greșeli Care Îți Distrug Website-ul (și Cum Le Eviți)",
    b5Date: "28 Februarie 2026",
    b5ReadFull: "7 min citire",
    b5Intro: 'Ai un website dar <strong>nu generează clienți?</strong> Probabil faci una (sau mai multe) din aceste 5 greșeli critice. Vestea bună: toate se pot repara. Iată ce verifici astăzi.',
    b5M1Title: "❌ Site lent (peste 3 secunde)",
    b5M1Desc: "53% din vizitatori pleacă dacă pagina durează mai mult de 3 secunde. Google penalizează site-urile lente. Cauze frecvente: imagini necompresate, CSS/JS ne-minificat, hosting ieftin, fără CDN.",
    b5M1Fix: "Soluție: Optimizează imaginile (WebP), minifică CSS/JS, folosește caching agresiv și un hosting rapid cu CDN.",
    b5M2Title: "❌ Fără SEO (invizibil pe Google)",
    b5M2Desc: "Un website frumos dar fără SEO este ca un magazin pe o stradă pustie. Fără title tags, meta descriptions, Schema.org, sitemap — Google nu te găsește și nu te afișează.",
    b5M2Fix: "Soluție: Implementează SEO tehnic complet — meta tags, Schema.org JSON-LD, sitemap.xml, robots.txt, Google Search Console.",
    b5M3Title: "❌ Nu e optimizat pentru mobil",
    b5M3Desc: "70% din trafic vine de pe telefon. Dacă site-ul tău nu arată bine pe mobil: text prea mic, butoane neapăsabile, elemente suprapuse — pierzi 7 din 10 vizitatori.",
    b5M3Fix: "Soluție: Design mobile-first cu TailwindCSS, testare pe dispozitive reale, touch targets minim 48x48px.",
    b5M4Title: "❌ Fără SSL (conexiune nesigură)",
    b5M4Desc: 'Chrome afișează „Not Secure" fără HTTPS. Google penalizează site-urile fără SSL în ranking. Vizitatorii nu au încredere să completeze formulare pe un site nesecurizat.',
    b5M4Fix: "Soluție: Certificat SSL gratuit (Let's Encrypt) sau hosting cu SSL inclus (Netlify, Vercel). HTTPS forțat pe toate paginile.",
    b5M5Title: "❌ Fără analytics (nu știi ce se întâmplă)",
    b5M5Desc: "Fără Google Analytics nu știi câți vizitatori ai, de unde vin, ce pagini vizitează sau de ce pleacă. Iei decizii pe baza presimțirilor, nu pe date reale.",
    b5M5Fix: "Soluție: Instalează Google Analytics 4 + Microsoft Clarity (heatmaps gratuite). Setează obiective de conversie.",
    b5H3_2: "💡 Concluzie: Un website bun = fundație solidă",
    b5P1: 'Aceste 5 greșeli sunt <strong>cele mai frecvente</strong> pe care le văd la clienții mei. Vestea bună: toate se rezolvă. Un website profesional construit corect de la început te scutește de pierderi de clienți, penalizări Google și costuri de reparare ulterioară.',
  ...
  en: {
    ...
    // Blog Page
    navBlog: "Blog",
    blogTag: "// Blog & Resources",
    blogTitle: 'Guides About <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-500">Web, AI & Business</span>',
    blogSubtitle: "Practical articles with concrete tips for entrepreneurs who want to digitalize their business in 2026.",
    blogStat1: "5 Articles",
    blogStat2: "~40 min total read",
    blogStat3: "Web · AI · SEO · Business",
    blogReadArticle: "Read Article",
    blogTocTitle: "Table of Contents",
    blogTocCta: "Free Consultation",
    blogShare: "Share:",
    blogCtaBadge: "Enjoyed reading?",
    blogCtaTitle: "Have Questions About Your Project?",
    blogCtaDesc: "Free consultation, no obligations. Let's discuss the best digital solution for your business.",
    blogCtaBtn1: "Write me on WhatsApp",
    blogCtaBtn2: "Send a Message",
    blogFooterServices: "Popular Services",
    blogFooterS1: "Full-Stack Web Apps",
    blogFooterS2: "AI & Chatbot Solutions",
    blogFooterS3: "Mobile Apps",
    blogFooterS4: "E-commerce & Marketplace",
    blogFooterS5: "Digital Marketing",
    b1Tag: "Price Guide",
    b1Read: "8 min",
    b1CardTitle: "How Much Does a Website Cost in 2026?",
    b1CardExcerpt: "Complete price guide: landing page, business website, e-commerce, AI app. Find out exactly how much to invest.",
    b1TocLink: "How Much Does a Website Cost?",
    b1Title: "How Much Does a Website Cost in 2026? Complete Price Guide",
    b1Date: "February 25, 2026",
    b1ReadFull: "8 min read",
    b1Intro: '<strong>Question #1 I get from clients:</strong> "How much does a website cost?" The answer depends on several factors, but in this guide I explain exactly what to expect in 2026.',
    b1H3_1: "💰 Website types and estimated prices in 2026",
    b1C1Title: "Landing Page / One-Page",
    b1C1Desc: "1-2 weeks · Modern design · Basic SEO · Mobile responsive · Contact form",
    b1C2Title: "Business Website (5-10 pages)",
    b1C2Desc: "3-6 weeks · CMS admin · Blog · Full SEO · Google Analytics · Multi-page",
    b1C3Title: "E-commerce / Online Store",
    b1C3Desc: "6-10 weeks · Product catalog · Online payments · Shopping cart · Admin panel",
    b1C4Title: "Custom Web App with AI",
    b1C4Desc: "2-4 months · CRM/Marketplace · AI Chatbot · Auth & RBAC · API integrations · SaaS",
    b1H3_2: "📊 What influences the price of a website?",
    b1F1: '<strong>Complexity</strong> — number of pages, features, API integrations, databases',
    b1F2: '<strong>Design</strong> — adapted template vs. custom design from scratch in Figma',
    b1F3: '<strong>AI Integration</strong> — OpenAI chatbot, automations, personalized recommendations',
    b1F4: '<strong>SEO & Marketing</strong> — search engine optimization, Schema markup, analytics',
    b1F5: '<strong>Maintenance</strong> — hosting, updates, backups, post-launch support',
    b1H3_3: "🎯 Why is it worth investing in a professional website?",
    b1P1: 'A website is <strong>the most important digital investment</strong> for any business in 2026. 87% of consumers search online before buying.',
    b1P2: 'Unlike paid ads, a well-optimized website <strong>attracts free organic traffic</strong> for months and years to come.',
    ...
    b2CardExcerpt: "How artificial intelligence transforms businesses: chatbots, automation, personalized marketing.",
    b2TocLink: "Why AI in 2026?",
    b2Title: "Why Your Business Needs AI in 2026",
    b2Date: "February 25, 2026",
    b2ReadFull: "7 min read",
    b2Intro: 'In 2026, <strong>artificial intelligence is no longer a luxury</strong> — it\'s a necessity. Businesses that don\'t use AI are losing ground to the competition.',
    b2H3_1: "🤖 5 Ways AI Transforms Your Business",
    b2Ai1Title: "AI Chatbot — 24/7 Support",
    b2Ai1Desc: 'A ChatGPT/OpenAI chatbot answers your clients instantly, non-stop. Increases conversions by <strong>up to 40%</strong>.',
    b2Ai2Title: "Marketing Automation",
    b2Ai2Desc: "Automatically personalized emails, AI audience segmentation, smart WhatsApp campaigns.",
    b2Ai3Title: "AI Data Analysis",
    b2Ai3Desc: "AI analyzes customer behavior, identifies buying patterns, predicts trends.",
    b2Ai4Title: "AI Content Generation",
    b2Ai4Desc: "Product descriptions, SEO articles, social media posts — all generated and optimized with AI.",
    b2Ai5Title: "Telegram & WhatsApp Bots",
    b2Ai5Desc: "Custom bots that process orders, send notifications, manage appointments.",
    b2H3_2: "📈 Statistics that matter",
    b2Stat1: "Conversions with AI chatbot",
    b2Stat2: "Time on repetitive tasks",
    b2Stat3: "Clients search online",
    b2Stat4: "Chatbot availability",
    b2CtaTitle: "Want to integrate AI into your business?",
    b2CtaDesc: "I'll discuss for free how you can implement chatbots, automations and custom AI solutions.",
    b2CtaBtn: "See AI Services",
    b3Tag: "Practical Guide",
    b3Read: "10 min",
    b3CardTitle: "How to Choose a Web Developer?",
    b3CardExcerpt: "10 essential criteria for choosing the right developer: portfolio, technologies, price, support.",
    b3TocLink: "How to Choose a Developer?",
    b3Title: "How to Choose a Web Developer in 2026: 10 Essential Criteria",
    b3Date: "February 25, 2026",
    b3ReadFull: "10 min read",
    b3Intro: 'Choosing a web developer can be overwhelming. <strong>There are thousands of options</strong> — freelancers, agencies, platforms. Here are <strong>10 concrete criteria</strong>.',
    b3C1Title: "Portfolio with real projects",
    b3C1Desc: "A good developer has a portfolio with live projects, not just mockups.",
    b3C2Title: "Modern technologies (2026-ready)",
    b3C2Desc: "Look for a developer who uses React, Laravel, Node.js, TailwindCSS.",
    b3C3Title: "AI & automation knowledge",
    b3C3Desc: "A developer who can't integrate AI is behind the times.",
    b3C4Title: "SEO from the start",
    b3C4Desc: "A website without SEO is an invisible website.",
    b3C5Title: "Responsive design (mobile-first)",
    b3C5Desc: "70% of traffic comes from mobile. A good developer builds for mobile first.",
    b3C6Title: "Clear and fast communication",
    b3C6Desc: "A developer who disappears for days is a major red flag.",
    b3C7Title: "Post-launch support included",
    b3C7Desc: "30 days of free support minimum.",
    b3C8Title: "Transparent pricing, no surprises",
    b3C8Desc: "Payment in stages (advance, milestone, delivery) is the trust standard.",
    b3C9Title: "Full-stack vs. specialist",
    b3C9Desc: "A full-stack developer covers everything — one single point of contact.",
    b3C10Title: "Real reviews and testimonials",
    b3C10Desc: "A developer with happy clients is the best quality indicator.",
    b3CtaTitle: "I check all 10 criteria ✓",
    b3CtaDesc: "Portfolio with live projects, modern technologies, AI integration, SEO, 30-day support.",
    b3CtaBtn1: "View Portfolio",
    b3CtaBtn2: "Discuss Your Project",

    // Blog Article 4: SEO in 2026
    b4Tag: "SEO & Visibility",
    b4Read: "9 min",
    b4CardTitle: "SEO in 2026: Complete Guide",
    b4CardExcerpt: "How to optimize your site for Google: keywords, speed, content, backlinks, and AI SEO.",
    b4TocLink: "SEO Complete Guide 2026",
    b4Title: "SEO in 2026: Complete Guide for Beginners",
    b4Date: "February 28, 2026",
    b4ReadFull: "9 min read",
    b4Intro: '<strong>SEO (Search Engine Optimization)</strong> is the process of optimizing your website to appear at the top positions in Google. In 2026, the rules have changed dramatically — AI, Core Web Vitals, and quality content are more important than ever.',
    b4H3_1: "🔍 What is SEO and why does it matter in 2026?",
    b4P1: "93% of online experiences begin with a search engine. If your website doesn't appear on the first page of Google, <strong>you practically don't exist online</strong>. SEO is the investment with the highest long-term ROI — each optimized article attracts free traffic for months and years.",
    b4H3_2: "📊 7 Pillars of Modern SEO in 2026",
    b4C1Title: "Core Web Vitals (Page Speed)",
    b4C1Desc: "Google measures LCP, FCP, CLS, and TBT. A site that loads in under 2 seconds gets a significant boost. Compress images, minify CSS/JS, use CDN.",
    b4C2Title: "Quality Content (E-E-A-T)",
    b4C2Desc: "Google evaluates Experience, Expertise, Authoritativeness, Trustworthiness. Write original, detailed content that solves real user problems.",
    b4C3Title: "Keywords (Keyword Research)",
    b4C3Desc: 'Use Google Keyword Planner, Ubersuggest, or Ahrefs. Focus on long-tail keywords with commercial intent: "how much does a website cost" not just "website".',
    b4C4Title: "Schema Markup (Structured Data)",
    b4C4Desc: "Add JSON-LD Schema.org: FAQ, HowTo, BreadcrumbList, LocalBusiness. Google displays rich snippets that increase CTR by 20-40%.",
    b4C5Title: "Mobile-First Indexing",
    b4C5Desc: "Google indexes the mobile version first. 70%+ of traffic comes from mobile. Responsive design is not optional — it's mandatory.",
    b4C6Title: "Quality Backlinks",
    b4C6Desc: "Links from other sites to yours = trust votes. Guest posting, local directories, partnerships. Quality beats quantity.",
    b4C7Title: "AI SEO & AEO (Answer Engine Optimization)",
    b4C7Desc: "In 2026, AIs (ChatGPT, Gemini, Copilot) read Schema.org and structured content. Optimize for AI engines, not just Google.",
    b4H3_3: "🎯 Quick SEO Checklist (10 Points)",
    b4F1: "<strong>Unique title tag</strong> on each page (50-60 characters, with main keyword)",
    b4F2: "<strong>Attractive meta description</strong> (150-160 characters, with CTA)",
    b4F3: "<strong>Unique H1</strong> on each page + hierarchical H2, H3 with keywords",
    b4F4: "<strong>Optimized images</strong> — WebP format, descriptive alt text, lazy loading",
    b4F5: "<strong>Active HTTPS</strong> — SSL certificate mandatory (penalty without it)",
    b4F6: "<strong>XML Sitemap</strong> + properly configured robots.txt",
    b4F7: "<strong>Google Search Console</strong> + Google Analytics 4 connected",
    b4F8: "<strong>Internal linking</strong> — link relevant pages between each other",
    b4F9: "<strong>Schema.org</strong> — JSON-LD on each page (FAQ, BreadcrumbList, etc.)",
    b4F10: "<strong>Regular content</strong> — blog with optimized articles, minimum 2/month",
    ...
    b5Read: "7 min",
    b5CardTitle: "5 Mistakes Destroying Your Website",
    b5CardExcerpt: "The most common errors: slow site, no SEO, not mobile-friendly, no SSL, no analytics. How to avoid them.",
    b5TocLink: "5 Common Mistakes",
    b5Title: "5 Mistakes Destroying Your Website (and How to Avoid Them)",
    b5Date: "February 28, 2026",
    b5ReadFull: "7 min read",
    b5Intro: 'You have a website but <strong>it\'s not generating clients?</strong> You\'re probably making one (or more) of these 5 critical mistakes. The good news: all of them can be fixed. Here\'s what to check today.',
    b5M1Title: "❌ Slow Site (over 3 seconds)",
    b5M1Desc: "53% of visitors leave if the page takes more than 3 seconds. Google penalizes slow sites. Common causes: uncompressed images, unminified CSS/JS, cheap hosting, no CDN.",
    b5M1Fix: "Solution: Optimize images (WebP), minify CSS/JS, use aggressive caching and fast hosting with CDN.",
    b5M2Title: "❌ No SEO (invisible on Google)",
    b5M2Desc: "A beautiful website without SEO is like a store on a deserted street. Without title tags, meta descriptions, Schema.org, sitemap — Google can't find you and won't display you.",
    b5M2Fix: "Solution: Implement complete technical SEO — meta tags, Schema.org JSON-LD, sitemap.xml, robots.txt, Google Search Console.",
    b5M3Title: "❌ Not optimized for mobile",
    b5M3Desc: "70% of traffic comes from phones. If your site doesn't look good on mobile: text too small, unclickable buttons, overlapping elements — you lose 7 out of 10 visitors.",
    b5M3Fix: "Solution: Mobile-first design with TailwindCSS, testing on real devices, touch targets minimum 48x48px.",
    b5M4Title: "❌ No SSL (insecure connection)",
    b5M4Desc: 'Chrome displays "Not Secure" without HTTPS. Google penalizes sites without SSL in rankings. Visitors won\'t trust filling out forms on an unsecured site.',
    b5M4Fix: "Solution: Free SSL certificate (Let's Encrypt) or hosting with included SSL (Netlify, Vercel). Force HTTPS on all pages.",
    b5M5Title: "❌ No analytics (you don't know what's happening)",
    b5M5Desc: "Without Google Analytics, you don't know how many visitors you have, where they come from, what pages they visit, or why they leave. You make decisions based on gut feelings, not real data.",
    b5M5Fix: "Solution: Install Google Analytics 4 + Microsoft Clarity (free heatmaps). Set up conversion goals.",
    b5H3_2: "💡 Conclusion: A good website = solid foundation",
    b5P1: 'These 5 mistakes are <strong>the most common</strong> I see with my clients. The good news: all of them are fixable. A professional website built correctly from the start saves you from lost clients, Google penalties, and repair costs later.',
...
function switchLanguage(lang) {
  ...
  document.querySelectorAll('[data-translate]').forEach(element => {
    ...
    if (translations[lang] && translations[lang][key]) {
      if (translations[lang][key].includes('<span') || translations[lang][key].includes('<br') || translations[lang][key].includes('<strong')) {
